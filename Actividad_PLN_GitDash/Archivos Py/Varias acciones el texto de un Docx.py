...
print('\n■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■ INICIO del Programa •Documento de WORD• ■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■')
...
# Ejemplo de uso
texto = read_docx("D:\\Tony\\Documents\\MEGAsync\\6to Sem\\Optativa PLN - Procesamiento de Lenguaje Natural\\PLN\\Actividad_PLN_GitDash\\Documentos\\archivo_DOCx.docx")
print(texto)
...
archivo_docx = ("D:\\Tony\\Documents\\MEGAsync\\6to Sem\\Optativa PLN - Procesamiento de Lenguaje Natural\\PLN\\Actividad_PLN_GitDash\\Documentos\\archivo_DOCx.docx")

# Lee el contenido del archivo DOCX
texto = read_docx(archivo_docx)

# Ruta del archivo TXT donde se guardará el contenido
archivo_txt = ("D:\\Tony\\Documents\\MEGAsync\\6to Sem\\Optativa PLN - Procesamiento de Lenguaje Natural\\PLN\\Actividad_PLN_GitDash\\Documentos\\contenido_archivo_DOCx.txt")

# Guarda el contenido en el archivo TXT
with open(archivo_txt, 'w') as file:
    file.write(texto)

print("El contenido del archivo DOCX se ha guardado en", archivo_txt)
...
print('Ingresa la Dirección URL: ')
url= input()
...
if texto_pagina:
    with open("D:\\Tony\\Documents\\MEGAsync\\6to Sem\\Optativa PLN - Procesamiento de Lenguaje Natural\\PLN\\Actividad_PLN_GitDash\\Documentos\\PLN_texto_pagina_web.txt", "w", encoding="utf-8") as archivo:
        ...
        print("El texto de la página se ha guardado correctamente en el archivo ► PLN_texto_pagina_web INPUT.txt ◄")
else:
...
with open("D:\\Tony\\Documents\\MEGAsync\\6to Sem\\Optativa PLN - Procesamiento de Lenguaje Natural\\PLN\\Actividad_PLN_GitDash\\Documentos\\PLN_texto_pagina_web INPUT EXTRAIDO.txt", "w", encoding="utf-8") as archivo_destino:
    archivo_destino.write(contenido)

print("El texto extraído se ha guardado correctamente en el archivo ► PLN_texto_pagina_web INPUT EXTRAIDO.txt ◄")
print("-------------------------------------------------------------------------------------------\n")
...
with open("D:\\Tony\\Documents\\MEGAsync\\6to Sem\\Optativa PLN - Procesamiento de Lenguaje Natural\\PLN\\Actividad_PLN_GitDash\\Documentos\\PLN_texto_pagina_web INPUT EXTRAIDO.txt", "r", encoding="utf-8") as archivo_extraido:
