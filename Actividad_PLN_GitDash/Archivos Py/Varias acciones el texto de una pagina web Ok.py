...
if texto_pagina:
    with open("Actividad_PLN_GitDash\\Documentos\\PLN_texto_pagina_web.txt", "w", encoding="utf-8") as archivo:
...
with open("Actividad_PLN_GitDash\\Documentos\\PLN_texto_pagina_web.txt", "r", encoding="utf-8") as archivo:
...
with open("Actividad_PLN_GitDash\\Documentos\\PLN_texto_pagina_web.txt", "r", encoding="utf-8") as archivo_origen:
    # Leer el contenido del archivo
    contenido = archivo_origen.read()

# Guardar el texto extraído en un nuevo archivo de texto
with open("Actividad_PLN_GitDash\\Documentos\\PLN_texto_pagina_web_EXTRAIDO.txt", "w", encoding="utf-8") as archivo_destino:
...
with open("Actividad_PLN_GitDash\\Documentos\\PLN_texto_pagina_web_EXTRAIDO.txt", "r", encoding="utf-8") as archivo_extraido:
