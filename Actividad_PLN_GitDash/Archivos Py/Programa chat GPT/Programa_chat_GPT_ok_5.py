...
class VentanaPrincipal:
    ...
    def enviar_mensaje(self):
        ...
        mensaje = self.texto_ingreso.get("1.0", tk.END)

        # Simplemente muestra el mismo mensaje en el área de respuesta por ahora
        self.area_respuesta.delete("1.0", tk.END)  # Borra el contenido anterior
        self.area_respuesta.insert(tk.END, mensaje)

    def guardar_txt(self):
        # Obtiene el texto en el área de respuesta
        texto = self.area_respuesta.get("1.0", tk.END)

        # Abre un cuadro de diálogo para guardar el archivo de texto
    ...
    def guardar_audio(self):
        ...
        # Convierte el texto en voz y guarda el archivo de audio
        engine = pyttsx3.init()
