def run_module5():
    print("Módulo 5 ejecutado - Tratamiento del archivo de Texto y conversión de estructura CSV")

print('Soy el archivo 5')
...
# Ejemplo de uso
texto = read_docx("D:\\00_programas_PLN\\archivos\\archivo_DOCx.docx")
print(texto)
...
archivo_docx = ("D:\\00_programas_PLN\\archivos\\archivo_DOCx.docx")

# Lee el contenido del archivo DOCX
texto = read_docx(archivo_docx)

# Ruta del archivo TXT donde se guardará el contenido
archivo_txt = ("D:\\00_programas_PLN\\archivos\\contenido_archivo_DOCx.txt")
...
if texto_pagina:
    with open("D:\\00_programas_PLN\\archivos\\PLN_texto_pagina_web.txt", "w", encoding="utf-8") as archivo:
...
with open("D:\\00_programas_PLN\\archivos\\PLN_texto_pagina_web.txt", "r", encoding="utf-8") as archivo:
...
with open("D:\\00_programas_PLN\\archivos\\PLN_texto_pagina_web.txt", "r", encoding="utf-8") as archivo_origen:
    # Leer el contenido del archivo
    contenido = archivo_origen.read()

# Guardar el texto extraído en un nuevo archivo de texto
with open("D:\\00_programas_PLN\\archivos\\PLN_texto_pagina_web INPUT EXTRAIDO.txt", "w", encoding="utf-8") as archivo_destino:
...
with open("D:\\00_programas_PLN\\archivos\\PLN_texto_pagina_web INPUT EXTRAIDO.txt", "r", encoding="utf-8") as archivo_extraido:
