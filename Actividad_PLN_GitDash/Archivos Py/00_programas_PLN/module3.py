def run_module3():
    print("Módulo 3 ejecutado - Tratamiento del archivo de Texto y conversión de estructura CSV")
...
def texto_a_audio(texto):
    engine = pyttsx3.init()
    engine.save_to_file(texto, 'D:\\00_programas_PLN\\archivos\\Audio_PLN_ttsX3.wav')  # Guarda el audio en un archivo
    engine.runAndWait()
    reproducir_audio('D:\\00_programas_PLN\\archivos\\Audio_PLN_ttsX3.wav')
